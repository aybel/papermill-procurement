...
class AuthController extends Controller
{
    ...
    public function setPassword(Request $request)
    {
        ...
        // Usamos el broker de contraseñas para resetearla
        ...
        if ($status == Password::PASSWORD_RESET) {
            return response()->json(['message' => 'Contraseña establecida exitosamente.']);
        }

        return response()->json(['message' => 'No se pudo establecer la contraseña, el token podría ser inválido.'], 400);
    }
